...
(defn register-resource-type
  ...
  [workspace & {:keys [textual? language editable ext build-ext node-type load-fn dependencies-fn search-fn search-value-fn read-fn write-fn icon view-types view-opts tags tag-opts template label stateless? lazy-loaded auto-connect-save-data?]}]
